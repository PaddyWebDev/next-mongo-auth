  ...
  "relative w-full rounded-lg border border-neutral-200 p-4 [&>svg~*]:pl-7 [&>svg+div]:translate-y-[-3px] [&>svg]:absolute [&>svg]:left-4 [&>svg]:top-4 [&>svg]:text-neutral-950 dark:border-neutral-800 dark:[&>svg]:text-neutral-50",
  {
    variants: {
      variant: {
        ...
        success:
          "border-emerald-500/50 text-emerald-500 dark:border-emerald-700 [&>svg]:text-emerald-500 dark:border-emerald-700/50 dark:text-emerald-400 dark:dark:border-emerald-700 dark:[&>svg]:text-emerald-400",
